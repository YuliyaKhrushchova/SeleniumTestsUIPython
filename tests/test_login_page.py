...
def test_valid_login(browser):
    ...
    browser.save_screenshot('login_valid.png')
...
def test_invalid_login(browser):
    ...
    browser.save_screenshot('login_invalid.png')
...
def test_go_to_register_page(browser):
    ...
    WebDriverWait(browser, 10).until_not(es.url_to_be(LOGIN_URL))
    browser.save_screenshot('login_to_register.png')
...
def test_go_to_main_page(browser):
    ...
    WebDriverWait(browser, 10).until_not(es.url_to_be(LOGIN_URL))
    browser.save_screenshot('login_to_main.png')
